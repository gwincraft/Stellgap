...
c
     ...
     >    aion, bion, cion
      ...
      open(unit=10, file="worker_input.dat", status="old")
      read(10, *) ir_start
      read(10, *) ir_end
      read(10, '(A)') outfile_worker
      close(unit=10)
...
c
      open(unit=21,file=trim(adjustl(outfile_worker)),status="unknown")
...
c
      ...
      stop
      end program tae_continua_worker
